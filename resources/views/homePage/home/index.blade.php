                                        ...
                                        <div class="container">
                                            <div class="entry-meta meta-0 font-small mb-20">
                                                <a href="category.html" tabindex="0"><span
                                                        class="post-cat text-info text-uppercase">{{ $row->category->name }}</span></a>
                                            </div>
                                            <h1 class="post-title mb-20 font-weight-900 text-white">
                                                <a class="text-white" href="{{ route('post.single', $row) }}"
                                                    tabindex="0">{{ $row->title }}</a>
                                            </h1>
                                        ...
                                        <div class="row mb-40 list-style-2">
                                            ...
                                            <div class="col-md-8 align-self-center">
                                                <div class="post-content">
                                                    <div class="entry-meta meta-0 font-small mb-10">
                                                        <span
                                                            class="post-cat text-primary">{{ $row->category->name }}</span>
                                                    </div>
                                                    ...
                                                    <div class="entry-meta meta-1 float-left font-x-small">
                                                        <span
                                                            class="post-on">{{ $row->created_at->diffForHumans() }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium"><a
                                                                href="{{ route('post.single', $row) }}">{{ $row->title }}</a>
                                                        </h6>
                                                        <div class="entry-meta meta-1 float-left font-x-small">
                                                            <span
                                                                class="post-on">{{ $row->created_at->diffForHumans() }}</span>
