    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Add New Links</h5>
                <hr/>
                            ...
                            <form action="{{route('admin.social.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="social_title" class="form-control" id="inputProductTitle" placeholder="Facebook">
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label"><h6>Links<span class="text-danger">*</span></h6></label>
                                        <input type="text" name="social_link" class="form-control" id="inputProductTitle" placeholder="http://yoursite.com/bhanu">
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label"><h6>Social Media Icon<span class="text-danger">*</span></h6></label>
                                        <input type="text" name="social_icon" class="form-control" id="inputProductTitle" placeholder="fa fa-facebook">
                                    </div>
